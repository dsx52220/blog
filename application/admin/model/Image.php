...
class Image extends BaseModel {
    ...
    public function getImgList($page, $list_row, $img_name = null) {
        ...
        $img_list = $img_m->where('is_del="0"')->order('id desc')->limit(($page - 1) * $list_row, $list_row)->select();
        return $img_list;
    }
    ...
    public function getImgTotal($img_name = null) {
        ...
        return $img_m->where('is_del="0"')->count(1);
    }
    ...
    public function imgDel($img_id) {
        return $this->where(['id' => $img_id])->update(['is_del' => 1]);
    }
